  ...
  <body class="bg-light">
    ...
    <div class="d-flex" id="wrapper">
      ...
      <main class="container">   
        <h3 class="mb-4 mt-4" style="text-align: left ">Data Kategori</h3>
        <!-- START DATA -->
        @if (session('status'))
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
          ...
          <div class=" d-flex bd-highlight mb-3">
                ...
                <div class="p-2 bd-highlight">
                  <a href='kategori/tambah' ><button type="button" class="btn btn-success"><img  src="image/plus.png" style="width: 25px" ></button> </a>
                </div>

                <div class=" p-2 bd-highlight">
                  <a href='/printdatakategori' ><button type="button" class="btn btn-success"><img src="image/printer.png" style="width: 25px" ></button> </a>
                </div>
                    ...
                    <thead>
                        <tr>
                          ...
                          <th style="width: 5%"> Gambar</th>
                            <th  style="width: 65%">@sortablelink('nama_kategori', 'Nama Ketegori') <img src="image/sort.png" width="15px"></th>
                            <th  style="width: 20%" class="text-center">Action</th>

                        </tr>
                    </thead>
                    <tbody>
                      @foreach ($datak as $index => $kategori)
                        <tr>
                          {{-- <td>{{ $loop->iteration }}</td> --}}
                          <td scope="row">{{$index + $datak->firstItem()}}</td>
                          <td>
                            <img src="{{asset($kategori ->gambar_kategori)}}" style="width: 100px">
                          </td>
                            <td>{{$kategori->nama_kategori}}</td>
                            <td class="d-flex justify-content-around" >
                                <a href="/kategori/{{$kategori ->id_kategori}}/edit"> <button type="button" class="btn btn-warning"><img  src="image/update.png" style="width: 25px" ></button> </a>
                                <form action="/kategori/{{$kategori ->id_kategori}}" method="POST" onsubmit="return confirmDelete(event)">
                                @method('DELETE')
                                @csrf
          ...
          {!! $datak->appends(\Request::except('page'))->render() !!}
