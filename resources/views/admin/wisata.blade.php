...
/* Mengubah warna background dan border pada pop up konfirmasi */
.confirm {
  background-color: #f8d7da;
  border-color: #f5c6cb;
}
/* Mengubah warna teks pada pop up konfirmasi */
.confirm-text {
  color: #721c24;
}
  ...
  <body class="bg-light">
    ...
    <div class="d-flex" id="wrapper">
      ...
      <main class="container">   
          <h3 class="mb-4 mt-4" style="text-align: left ">Data Wisata Jogja</h3>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm ">
          ...
          <div class="d-flex bd-highlight mb-3">
            <!-- TOMBOL TAMBAH DATA -->
            <div class="p-2 bd-highlight logo">
              <a class="tambah" href='/wisata/tambah' ><button  type="button" class="btn btn-success"><img  src="image/plus.png" style="width: 25px" ></button> </a>
            </div>

            <div class=" p-2 bd-highlight logo">
              <a class="print" href='/printdatawisata' ><button type="button" class="btn btn-success"><img src="image/printer.png" style="width: 25px" ></button> </a>
            </div>
                    ...
                    <thead>
                        <tr>
                          ...
                          <th style="width: 5%"> No</th>
                            ...
                            <th class="col-md-3">@sortablelink('nama_wisata', 'Nama Wisata')<img src="image/sort.png" width="15px"></th>
                            {{-- <th class="col-md-3"><a @sortableHref>Tour Name @sortableIcon('nama_wisata')</a></th> --}}
                            
                            <th class="col-md-2">@sortablelink('alamat', 'Alamat')<img src="image/sort.png" width="15px"></th>
                          ...
                          <td scope="row">{{$index + $data->firstItem()}}</td>
                           ...
                           <td>{{$wisata->nama_wisata}}</td>
                            ...
                            <td class="d-flex justify-content-between">
                              <a href="/wisata/{{$wisata ->id_wisata}}/detail"><button type="button" class="btn btn-info"><img  src="image/read.png" style="width: 25px" ></button></a>
                              <a href="/wisata/{{$wisata ->id_wisata}}/edit"> <button type="button" class="btn btn-warning"><img  src="image/update.png" style="width: 25px" ></button> </a>
                                <form action="/wisata/{{$wisata ->id_wisata}}" method="POST" onsubmit="return confirmDelete(event)">
                                  @method('DELETE')
                                  @csrf
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
      <script>
        ...
        Swal.fire({
          title: 'Apakah Anda yakin ingin menghapus data wisata ini?',
