        ...
        <div class="relative flex items-top justify-center min-h-screen bg-blue-400 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <img src="/asset/logo2.png" style="width: 500px">
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        @if (Route::has('login'))
                            <div class="hidden fixed  px-6 py-4 sm:block">
                                ...
                                @else
                                    <a href="{{ route('login') }}" class="text-lg text-gray-700 dark:text-gray-500 underline">
                                        <button class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">
                                            Login
                                        </button>
                                    </a>
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="ml-4 text-lg text-gray-700 dark:text-gray-500 underline">
                                            <button class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">
                                                Register
                                            </button>
                                        </a>
